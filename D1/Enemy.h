...
public:
	...
	inline ECreatureSpriteIndex		GetSpriteIndex() const { return SpriteIndex; }
	inline bool						GetbBlink() const { return bBlink; }
	inline void						SetSpriteIndex(ECreatureSpriteIndex InValue) { SpriteIndex = InValue; }
};
